...
символов!", self._Goods__name)
    ...
    def load_from_csv(cls, path) -> list:
        ...
        Goods.
        В случае, если файл не найден по указанному пути, выбрасывается 
        исключение FileNotFindError.
        Если файл существует, но в нем присутствуют не все требуемые 
        столбцы- InstantiateCSVError.
